...
namespace AssetBundleBrowser
{
    ...
    public class AssetBundleBrowserMain : EditorWindow, IHasCustomMenu, ISerializationCallbackReceiver
    {
        ...
        [SerializeField]
        internal AssetBundleUploaderTab m_UpdloaderTab;
        ...
        private void OnEnable()
        {
            ...
            if (m_UpdloaderTab == null) {
                m_UpdloaderTab = new AssetBundleUploaderTab();
            }
            m_UpdloaderTab.OnEnable(this);
        ...
        void ModeToggle()
        {
            ...
            string[] labels = new string[4] { "Configure", "Build", "Uploader", "Inspect" };
